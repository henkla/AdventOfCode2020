            ...
            switch (key)
            {
                ...
                case PassportEntry.hgt:
                    ...
                    if (value.Contains("cm"))
                    {
                        ...
                        if (int.TryParse(value.Split("cm")[0], out numericValue) && numericValue >= 150 && numericValue <= 193)
                        {
                            validatedValue = value;
                        }
                    }
                    else if (value.Contains("in"))
                    {
                        ...
                        if (int.TryParse(value.Split("in")[0], out numericValue) && numericValue >= 59 && numericValue <= 76)
                        {
                            validatedValue = value;
                        }
                    }
